...
<form method="post" action="../processing/employeeSearch.php">
<span class="normal">
<table>
	<tr>
		<td colspan="2">Search for an employee by entering the desired criteria in the
...
?>
	...
	<tr>
		<td>Name:</td>
		<td><input type="text" name="search_fullName" /></td>
	</tr>
	<tr>
		<td>Email:</td>
		<td><input type="text" name="search_email" /></td>
	</tr>
	<tr>
