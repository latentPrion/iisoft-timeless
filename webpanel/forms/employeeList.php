...
<form method="post" action="../processing/employeeView.php">
<span class="normal">
<?php
	$resultHandle = odbc_exec($dbHandle, "select * from employee");
?>
...
?></td>
	...
	<tr>
		<td colspan="4">Employee listing.</td>
	</tr>
	<tr>
		<td>Id:</td>
		<td>Name:</td>
	...
	<tr>
		...
		<td>
			<?php
				...
				{
				default:
					echo "<a href=\"processing/employeeDetails.php?id=" . odbc_result($resultHandle, "id") . "\">View details</a>";
					break;

				case 'edit':
					echo "<a href=\"form.php?table=employee&form=Edit&id=" . odbc_result($resultHandle, "id") . "\">Edit employee</a>";
					break;

				case 'remove':
					echo "<a href=\"processing/employeeRemove.php?id=" . odbc_result($resultHandle, "id") . "\">Delete employee</a>";
					break;
				};
			?>
		</td>
