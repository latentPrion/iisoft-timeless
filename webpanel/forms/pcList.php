...
<form method="post" action="../processing/pcView.php">
<span class="normal">
<?php
	$resultHandle = odbc_exec($dbHandle, "select * from pc");
?>
	...
	<tr>
		...
		<td>
			<?php
				...
				{
				default:
					echo "<a href=\"processing/pcDetails.php?id=" . odbc_result($resultHandle, "id") . "\">View details</a>";
					break;

				case 'edit':
					echo "<a href=\"form.php?table=pc&form=Edit&id=" . odbc_result($resultHandle, "id") . "\">Edit pc</a>";
					break;

				case 'remove':
					echo "<a href=\"processing/pcRemove.php?id=" . odbc_result($resultHandle, "id") . "\">Delete pc</a>";
					break;
				};
			?>
		</td>
